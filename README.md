...
Per Section 15(vi) of the project brief, AI assistance must be
acknowledged. This entire codebase (project structure, schema, seed
data generator, custom data structures, algorithms, graph engine,
optimisation layer, integrated dispatch service, and performance lab)
was built with Claude. Keep a record of prompts used, and make sure
every team member can explain and modify the code they're responsible
for defending in the oral demo.
